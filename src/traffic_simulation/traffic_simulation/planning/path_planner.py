...
class PathPlanner(Node):
    ...
    def map_callback(self, msg):
        ...
        self.get_logger().info("Harita güncellendi.")
        self.plan_path()

    def start_callback(self, msg):
        self.start = (int(msg.point.x), int(msg.point.y))
        self.get_logger().info(f"Başlangıç noktası alındı: {self.start}")
        self.plan_path()

    def goal_callback(self, msg):
        self.goal = (int(msg.point.x), int(msg.point.y))
        self.get_logger().info(f"Hedef noktası alındı: {self.goal}")
        self.plan_path()
    ...
    def plan_path(self):
        ...
        self.get_logger().warn("Yol bulunamadı!")
    ...
    def publish_path(self, path):
        ...
        self.get_logger().info(f"{len(path)} noktalı yol yayınlandı")
