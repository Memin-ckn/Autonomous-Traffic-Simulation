...
"""
Vehicle visualization module for the traffic simulation.
This module handles the visual representation and display aspects of vehicles,
separate from the core vehicle behavior implementation in /vehicles/vehicle.py.
"""
